...
6. Set up a checking account, a _Personal Escrow_ savings account, and one savings account for each __targeted goal__ - We use [Capital One 360](https://www.capitalone.com/bank/){: target="_blank" }
...
10. Track your spending in detail and use that information to evolve your budget to be more accurate. I recommend you use [Thrifty]({{site.url}}/thrifty){: target="_blank"}, Personal Capital, or Mint.
