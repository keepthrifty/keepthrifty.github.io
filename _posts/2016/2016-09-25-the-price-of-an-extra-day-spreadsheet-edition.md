...
![]({{ site.url }}{{ page.image-folder }}/s-21.jpg)
...
![]({{ site.url }}{{ page.image-folder }}/s-36.jpg)
...
_If you come up with some cool options or any additions to the sheet, let me know in the comments below or [contact me]({{site.url}}/work-with-us/) - I'd love to hear what you come up with. Happy spreadsheeting!_
